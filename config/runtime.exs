...
#
#     PHX_SERVER=true bin/airline_seat_reservation start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :airline_seat_reservation, AirlineSeatReservationWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  #
  #     config :airline_seat_reservation, AirlineSeatReservation.Mailer,
